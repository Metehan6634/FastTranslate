...
Fast Translate; bilgisayarda çalışırken, kod yazarken, makale okurken veya oyun oynarken klavye kısayolları ile anında çeviri yapmanızı sağlayan, şeffaf arayüzlü ve sesli okuma özellikli modern bir Windows aracıdır.

## ✨ Öne Çıkan Özellikler

* **⚡ Anında Kısayol Çevirisi:** Sadece metni yazın ve belirlediğiniz kısayola (Örn: `Alt + T`) basın. Program saniyeler içinde metni çevirip panonuza kopyalar ve otomatik olarak ekrana yapıştırır.
...
## 🛠️ Kurulum ve Kullanım (Normal Kullanıcılar İçin)
...
1. Projeyi klonlayın:
```bash
git clone https://github.com/Metehan6634/FastTranslate.git
Bash

pip install -r requirements.txt

⚠️ Bilinen Durumlar ve Çözümler
Kısayollar Çalışmıyor: Uygulamayı mutlaka Yönetici (Administrator) haklarıyla çalıştırın. Windows güvenlik duvarı klavye dinleme (keyboard modülü) işlemlerini kısıtlayabilir.

"æ" Karakteri Çıkma Sorunu: v6.2 ile çözülmüştür. Güvenli tuş tahliye sistemi entegre edilmiştir.
